...
torch.save(obj=MOBILENET_V3_21K.state_dict(), f='trained_models/mobilenet_v3_large_21k.pt')

testing_metrics.print_performance()
testing_metrics.export_to_csv(filename='results/metrics_test_mobilenet_v3_21k')
training_metrics.export_to_csv(filename='results/metrics_train_mobilenet_v3_21k')